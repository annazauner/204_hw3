...
Decrease to: EDIT NEEDED $ **($`r round(cs_low_tax, 2)`)**
...
# Demand functions (high and low) with solar and SCC at 51
...
```{r eval = FALSE}
# Find the new equilibrium price (at the intersection agg demand and supply curve)
...
# Find the total environmental externality (Q * MEC of 1.97 cents)
env_cost_solar <- mpc_q(5.84)*(1.97)

env_cost_solar

```

- Quantity of electricity consumed: r round(solar_electricity, 2)` kWh
- Total cost of environmental damages: $r round(solar_electricity, 2)`
